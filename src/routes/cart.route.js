...
const {CreateCart, getAllCart, getBranchCart, addProduct, getCartProduct, updateCart, deleteProduct, custCart} = require("../controllers/cart.controller")
...
router.route("/customer").get(custCart)
